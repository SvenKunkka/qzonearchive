...
const pageTitle = computed(() => String(route.meta.title ?? "空间归档"));
const DISCLAIMER_VERSION = "2026-07-18-v1";
...
<template>
  ...
  <Dialog :visible="!disclaimerAccepted" modal :closable="false" :draggable="false" :close-on-escape="false" class="disclaimer-dialog" header="免责声明与使用须知">
    <div class="disclaimer-heading"><span><i class="pi pi-shield" /></span><div><strong>请在使用空间归档前仔细阅读</strong><small>协议版本：2026-07-18 · 只有同意后才能进入应用</small></div></div>
    <div class="disclaimer-content">
      <section><h4>一、软件性质与非官方声明</h4><p>空间归档（以下简称“本软件”）是用于整理和备份个人 QQ 空间资料的本地工具，与腾讯公司、QQ、QQ 空间及其关联主体不存在隶属、授权、合作、代理或担保关系。QQ、QQ 空间及相关名称、商标、接口与内容权利归相应权利人所有。本软件不承诺第三方服务持续可用，也不对其规则、接口或技术调整负责。</p></section>
      ...
      <section><h4>八、功能与可用性说明</h4><p>本软件按现状提供，不保证无错误、不中断、适合特定目的，也不保证能够获取全部历史数据或长期兼容所有设备和第三方接口。请求间隔、重试、断点续传等机制只能降低部分失败概率，不能消除封禁、限流、接口停用或内容不可恢复风险。</p></section>
